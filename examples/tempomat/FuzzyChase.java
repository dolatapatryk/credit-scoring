...
class DrawingTask extends TimerTask {
    ...
    DrawingTask(JPanel panel) throws IOException{
        ...
        tab_interval=new int[] { 1000, 2000, 3000, 4000 };	  				//Czas jak dlugo porusza sie z dana predkosca samochod 1
...
//		fis.setVariable("speed", 45);
//		fis.setVariable("distance", 25);
//		fis.evaluate();
//		Variable acceleration = functionBlock.getVariable("acceleration");
//		JFuzzyChart.get().chart(acceleration, acceleration.getDefuzzifier(), true);
//        System.out.println(fis);
//        System.out.println("Acceleration: " + fis.getVariable("acceleration").getValue());
    }
...
//------------>  samochod 2 - sterownik rozmyty  <------------\\
	...
	System.out.printf("S1: %8.4f\t  S2: %8.4f\t D:%8.4f\t => P:%8.4f%n", speed1*10000, speed2*10000, (phi1-phi2)*100, speed_change); //Wyswietla parametry na konsoli
